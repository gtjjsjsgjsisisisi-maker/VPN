...
local ToggleFallbackText = Instance.new("TextLabel")
ToggleFallbackText.Size = UDim2.new(1, 0, 1, 0)
ToggleFallbackText.Text = "EXC"
ToggleFallbackText.TextColor3 = Color3.fromRGB(255, 255, 255)
ToggleFallbackText.TextSize = 11
ToggleFallbackText.Font = Enum.Font.SourceSansBold
ToggleFallbackText.BackgroundTransparency = 1
ToggleFallbackText.ZIndex = 0
ToggleFallbackText.Parent = ToggleBtn

task.spawn(function()
    pcall(function()
        local objects = game:GetObjects("rbxassetid://559906823")
        if objects and #objects > 0 and objects[1]:IsA("Decal") then
            ToggleBtn.Image = objects[1].Texture
        end
    end)
end)
...
CloseBtnStroke.Color = Color3.fromRGB(70, 70, 70)
...
-- ==================== CUSTOM SERVER SCANNER POPUP (EXC HUB) ====================
...
-- ปุ่มย้ายเข้าเซิฟ 1 คน + ป๊อปอัปสแกนสไตล์ EXC HUB
